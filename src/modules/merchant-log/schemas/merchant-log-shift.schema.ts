...
export class MerchantJournal extends Document {
  ...
  // Jenis mutasi: 'SALE', 'RESTOCK', 'ADJUSTMENT_IN','ADJUSTMENT_OUT', 'WASTE', 'PRICE_UPDATE'
  @Prop({ required: true, index: true })
  action_type!: string;
...
export const MerchantJournalSchema = SchemaFactory.createForClass(MerchantJournal);